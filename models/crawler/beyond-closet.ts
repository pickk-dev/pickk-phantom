...
export default class BeyondClosetCrawler implements ICrawler {
  url: string;
  productNum: number;
  ...
  getOptionNames = async () => {
    ...
    hi(
      '#contents > div.xans-element-.xans-product.xans-product-detail > div.detailArea > div.infoArea > table > tbody > tr.xans-element-.xans-product.xans-product-option.xans-record- > th'
    ).each((_, ele) => {
