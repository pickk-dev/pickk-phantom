...
export default class TheBurningCrawler implements ICrawler {
  url: string;
  productNum: number;
  ...
  getOptionNames = async () => {
    ...
    hi(
      '#sub_contents > div.xans-element-.xans-product.xans-product-detail > div > div.detailArea > div.infoArea > table > tbody.xans-element-.xans-product.xans-product-option.xans-record- > tr > th'
    ).each((_, ele) => {
