...
export default class RdvzCrawler implements ICrawler {
  url: string;
  productNum: number;
  ...
  getOptionNames = async () => {
    ...
    hi(
      '#contents_detail > div > div.item2 > div.xans-element-.xans-product.xans-product-detail > div.infoArea > table > tbody.xans-element-.xans-product.xans-product-option.xans-record- > tr > th'
    ).each((_, ele) => {
