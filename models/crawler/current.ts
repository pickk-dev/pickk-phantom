...
export default class CurrentCrawler implements ICrawler {
  url: string;
  productNum: number;
  ...
  getOptionNames = async () => {
    ...
    hi(
      "#mun_option > div.xans-element-.xans-product.xans-product-option.mun-detail-list.mun-option.xans-record- > div.mun-detail-desc > ul"
    ).each((_, ele) => {
